...
/**
 * Servlet implementation class ActionFastWithdraw
 */
@WebServlet("/ActionFastWithdraw")
public class ActionFastWithdraw extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ActionFastWithdraw() {
		super();
